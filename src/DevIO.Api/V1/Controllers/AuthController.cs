    ...
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Registrar(RegisterUserViewModel registerUser)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return CustomResponse(await GerarJTW(registerUser.Email));
            }
        ...
        public async Task<ActionResult> Login(LoginUserViewModel loginUser)
        {
            ...
            if (result.Succeeded)
                return CustomResponse(await GerarJTW(loginUser.Email));
        ...
        private async Task<LoginResponseViewModel> GerarJTW(string email)
        {
